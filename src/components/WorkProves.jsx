...
const WorkProves = () => {
  ...
  return (
    <div id="experience" ref={ref} className="container mx-auto mt-20 p-8 rounded-lg flex flex-col justify-center text-center shadow-lg max-w-2xl">
      <h2 className="text-4xl text-[#18d49c] font-bold mb-6 text-center">
        My Work Experience
      </h2>
